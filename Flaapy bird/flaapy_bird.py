...
GAME_SPRITES = {}# all images used in game
GAME_SOUNDS = {} # all sounds used in the game
PLAYER = 'sprites/bird.png'
BACKGROUND = 'sprites/background.png'
PIPE = 'sprites/pipe.png'
game_over=False
# location of all the above three
def welcomeScreen():
    """
...
def getRandomPipe():
    ...
    y2 = offset + random.randrange(100, int(SCREENHEIGHT - GAME_SPRITES['base'].get_height() - 1.2* offset))
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird Made by Eshaan Manchanda')
    GAME_SPRITES['numbers'] = (
        pygame.image.load('sprites/0.png').convert_alpha(),#covert_alpha modifi image and optimize image for game
